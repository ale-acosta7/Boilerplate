...
SECRET_KEY = 'django-insecure-1+uy_^bs9+l*tu7g5k7@ty_hj9xnn*7x02-$4m^fw%82%w)fea'
...
# Python 3.10.0 asyncio bug -> "loop argument must agree with lock"
# Using in-memory channel layer instead for dev *only* until 3.10.1
"""
CHANNEL_LAYERS = {
    'default': {
...
LOGGING = {
    ...
    'formatters': {
        'verbose': {
            'format': '[{levelname}] {module}.{funcName} at line {lineno}: {message}',
            'style': '{'
        }
    }
}
